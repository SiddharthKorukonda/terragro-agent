...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=terragro-agent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(
            f"Google Cloud credentials not found or telemetry setup failed: {e}. "
            "Bypassing Cloud Trace & Logging telemetry exporters for local development."
        )
